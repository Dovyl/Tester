...
if Client.leaderstats.Diamonds.Value < _G.Diamonds then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Dovyl/cpaapachupu/main/chapa.lua"))()
	wait(55555555)
end
